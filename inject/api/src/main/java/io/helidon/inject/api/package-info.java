 ...
 * <ul>
 * <li>{@link io.helidon.inject.service.Inject.Contract} - signifies that the type can be used for lookup in the service registry.</li>
 * <li>{@link io.helidon.inject.service.Inject.ExternalContracts} - same as Contract, but applied to the implementation class instead.</li>
 * <li>{@link io.helidon.inject.service.Inject.RunLevel} - ascribes meaning for when the service should start.</li>
 * </ul>
 * <p>
