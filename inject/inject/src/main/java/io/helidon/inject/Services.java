...
public interface Services {
     ...
     * @param <T>    type of the expected service providers, use {@code ?} if not known
     * @return the best service provider matching the lookup, cast to the expected type; please use a {@code ?} as the type
     ...
     *
     * @param lookup lookup to use
     * @param <T>    type of the expected service suppliers, use {@code ?} if not known, or may contain a mix of types
     * @return list of service suppliers ordered, may be empty if there is no match, cast to the expected type; please use a
     *         {@code ?} as the type if the result may contain unknown provider types (or a mixture of them)
     */
     ...
     *
     * @param lookup lookup to use
     * @param <T>    type of the expected service providers, use {@code ?} if not known, or may contain a mix of types
