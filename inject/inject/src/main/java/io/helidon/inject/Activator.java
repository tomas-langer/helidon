 ...
 * {@link io.helidon.inject.ServiceProvider}'s manage service instance from {@link io.helidon.inject.Phase#PENDING}
 * through {@link io.helidon.inject.Phase#POST_CONSTRUCTING} (i.e., including any
 * {@link io.helidon.inject.PostConstructMethod} invocations, etc.), and finally into the
 * {@link io.helidon.inject.Phase#ACTIVE} phase.
 * <p>
 * Assumption:
 * <ol>
 *  <li>Each {@link io.helidon.inject.ServiceProvider} managing its backing service will have an activator strategy conforming to the DI
 *  specification.</li>
 * </ol>
 * Activation includes:
 * <ol>
 ...
 *  <li>Invocation of any {@link io.helidon.inject.PostConstructMethod}.</li>
 *  <li>Responsible to logging to the {@link io.helidon.inject.ActivationLog} - see {@link io.helidon.inject.InjectionServices#activationLog()}.</li>
 * </ol>
 *
 * The activator also supports the inverse process of deactivation, where any {@link io.helidon.inject.service.Injection.PreDestroy}
