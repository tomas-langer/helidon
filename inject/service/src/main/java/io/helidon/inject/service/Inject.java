...
/**
 * Injection annotations and APIs.
 */
public final class Inject {
     ...
     * with any of the supported annotations (such as {@link Inject}.
    ...
    /**
     * Placed on the implementation of a service as an alternative to using a {@link io.helidon.inject.service.Inject.Contract}.
     * <p>
     ...
     * consider
     * using {@link io.helidon.inject.service.Inject.ExternalContracts} instead - this annotation can be placed on the
    ...
    /**
     * This annotation is effectively the same as {@link io.helidon.inject.service.Inject.Named}
     * where the {@link io.helidon.inject.service.Inject.Named#value()} is a {@link Class}
     ...
     * (such as @{@link io.helidon.inject.service.Inject.Singleton} service instances) that is being terminated.
     * <p>
     * The method must not have any parameters and must be accessible (not {@code private}).
     * <p>
