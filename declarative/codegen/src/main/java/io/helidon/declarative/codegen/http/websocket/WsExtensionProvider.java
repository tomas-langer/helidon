...
package io.helidon.declarative.codegen.http.websocket;
 ...
 * services to handle declarative websocket endpoints.
 */
public class WsExtensionProvider implements RegistryCodegenExtensionProvider {
     ...
     */
    @Deprecated
    public WsExtensionProvider() {
    }

    @Override
    public Set<TypeName> supportedAnnotations() {
        return Set.of(WsTypes.SERVER_ENDPOINT);
    }

    @Override
    public RegistryCodegenExtension create(RegistryCodegenContext codegenContext) {
        return new WsExtension(codegenContext);
    }
}
