 ...
 * <p>
 * This class also contains string method names, such as {@link #GET_STRING} to allow usage in annotations.
 */
public final class Method {
     ...
     * to a database.
     */
    public static final Method POST = new Method(POST_STRING, true);
    /**
     ...
     */
    public static final Method PUT = new Method(PUT_STRING, true);
    /**
     ...
     */
    public static final Method DELETE = new Method(DELETE_STRING, true);
    /**
     ...
     */
    public static final Method HEAD = new Method(HEAD_STRING, true);
    /**
     ...
     */
    public static final Method OPTIONS = new Method(OPTIONS_STRING, true);
    /**
     ...
     */
    public static final Method TRACE = new Method(TRACE_STRING, true);
    /**
     ...
     */
    public static final Method PATCH = new Method(PATCH_STRING, true);

    /**
     * The HTTP CONNECT method starts two-way communications with the requested resource. It can be used to open a tunnel.
     */
    public static final Method CONNECT = new Method(CONNECT_STRING, true);
