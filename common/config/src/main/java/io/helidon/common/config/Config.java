...
public interface Config {
    ...
    @interface Value {
         ...
         * <p>
         * Default values will have string converters applied if the type is not {@link java.lang.String}.
        ...
        /**
         * Default value of {@link io.helidon.common.config.Config.Value#defaultProvider()}.
         */
        class NoProvider implements Function<Config, Object> {
            @Override
