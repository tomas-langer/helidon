...
final class HelidonContainerImpl extends Weld implements HelidonContainer {
    ...
    void initInContext() {
        ...
        LOGGER.fine("Container initialized in " + now + " millis");
    }
    ...
    private HelidonContainerImpl init() {
        ...
        beanManager.fireEvent(new Object(), BuildTimeScoped.INITIALIZED_LITERAL);
        ...
        beanManager.fireEvent(new Object(), BuildTimeScoped.BEFORE_DESTROYED_LITERAL);
        beanManager.fireEvent(new Object(), BuildTimeScoped.DESTROYED_LITERAL);
    ...
    private HelidonContainerImpl doStart() {
        ...
        bm.fireEvent(config, RuntimeScoped.INITIALIZED_LITERAL);
        ...
        bm.fireEvent(new ContainerInitialized(id), Initialized.Literal.APPLICATION);
        ...
        public void close() {
            if (isRunning.compareAndSet(true, false)) {
                try {
                    ...
                    beanManager().fireEvent(new Object(), RuntimeScoped.BEFORE_DESTROYED_LITERAL);
                } finally {
                    // Destroy all the dependent beans correctly
                    beanManager().fireEvent(new ContainerShutdown(id), Destroyed.Literal.APPLICATION);
                    beanManager().fireEvent(new Object(), RuntimeScoped.DESTROYED_LITERAL);
                    bootstrap.shutdown();
