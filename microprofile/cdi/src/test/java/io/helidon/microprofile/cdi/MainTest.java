...
class MainTest {
    ...
    void testEvents() {
        ...
        assertThat(extension.events(), contains(TestExtension.BUILD_TIME_INIT,
                                                TestExtension.BUILD_TIME_BEFORE_DESTROYED,
                                                TestExtension.BUILD_TIME_DESTROYED));
        ...
        instance.shutdown();
        assertThat(extension.events(), is(List.of(TestExtension.BUILD_TIME_INIT,
                                                  TestExtension.BUILD_TIME_BEFORE_DESTROYED,
                                                  TestExtension.BUILD_TIME_DESTROYED,
                                                  TestExtension.RUNTIME_INIT,
                                                  TestExtension.APPLICATION_INIT,
                                                  TestExtension.APPLICATION_BEFORE_DESTROYED,
                                                  TestExtension.RUNTIME_BEFORE_DESTROYED,
                                                  TestExtension.APPLICATION_DESTROYED,
                                                  TestExtension.RUNTIME_DESTROYED)));
    }
}