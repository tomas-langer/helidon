...
public final class FaultTolerance {
    ...
    public @interface Bulkhead {
         ...
         *
         * @return maximal number of parallel calls, defaults is {@value io.helidon.nima.faulttolerance.BulkheadConfig#DEFAULT_LIMIT}
         */
        int limit() default BulkheadConfig.DEFAULT_LIMIT;
         ...
         */
        int queueLength() default BulkheadConfig.DEFAULT_QUEUE_LENGTH;
    ...
    public @interface CircuitBreaker {
         ...
         * Default is {@value io.helidon.nima.faulttolerance.CircuitBreakerConfig#DEFAULT_ERROR_RATIO}.
         *
         * @return percent of failure that trigger the circuit to open
         * @see #volume()
         */
        int errorRatio() default CircuitBreakerConfig.DEFAULT_ERROR_RATIO;

        /**
         * Rolling window size used to calculate ratio of failed requests.
         * Default is {@value io.helidon.nima.faulttolerance.CircuitBreakerConfig#DEFAULT_VOLUME}.
         *
         * @return how big a window is used to calculate error errorRatio
         * @see #errorRatio()
         */
        int volume() default CircuitBreakerConfig.DEFAULT_VOLUME;

        /**
         * How many successful calls will close a half-open circuit.
         * Nevertheless, the first failed call will open the circuit again.
         * Default is {@value io.helidon.nima.faulttolerance.CircuitBreakerConfig#DEFAULT_SUCCESS_THRESHOLD}.
         *
         * @return number of calls
         */
        int successThreshold() default CircuitBreakerConfig.DEFAULT_SUCCESS_THRESHOLD;
