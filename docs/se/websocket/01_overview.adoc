...
the web server. This is accomplished via a `SetupRouting` builder:
...
This code snippet uses multiple builders for `SetupRouting`, `TyrusSupport` and `ServerEndpointConfig`.
